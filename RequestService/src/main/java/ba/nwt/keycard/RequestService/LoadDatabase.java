...
public class LoadDatabase {
    ...
    CommandLineRunner initData(UserRepository userRepository, KeycardRepository keycardRepository,
        ...
        return args -> {
            ...
            User user1 = new User("username1", "email1@example.com", "password1", "role1", true, keycard1, team1);
            User user2 = new User("username2", "email2@example.com", "password2", "role2", true, keycard2, team2);
